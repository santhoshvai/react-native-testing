...
it('renders modal screen correctly', async () => {
  ...
  expect(() => getByText(/hello world/i)).toThrow("Unable to find an element with text: /hello world/i") //modal is initially closed
  ...
  expect(() => getByText(/hide modal/i)).toThrow("Unable to find an element with text: /hide modal/i") //modal is closed again
})
